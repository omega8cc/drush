...
class DrupalBoot11 extends DrupalBoot {
  ...
  function bootstrap_drupal_full() {
    drush_log(dt('About to bootstrap the Drupal 11 Kernel.'), LogLevel::DEBUG);
    ...
    drush_log(dt('Finished bootstraping the Drupal 11 Kernel.'), LogLevel::DEBUG);
